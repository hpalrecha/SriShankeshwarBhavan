...
```
Changelog:
- July 30, 2025: MAJOR UI/UX ENHANCEMENT COMPLETE - Updated logo to new SSBB temple image, added bulk booking WhatsApp integration (9902123456) for 20+ rooms, simplified guest booking form to only require name and mobile (email optional), added Indian states dropdown, updated amenities section with 24/7 security, driver freshen up facility, Satvik Bhojanshala with Rajasthani swaad, 24-hour stay policy, removed WiFi/tea-coffee amenities, updated location details with accurate distances and travel times, corrected address to "Sri Shankeshwar Bengaluru Bhavan Trust Near Shankeshwar Parshwanath Temple"
